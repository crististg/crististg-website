  ...
  <header className="border-b border-black/6 bg-transparent py-4">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6">
        ...
        <nav className="hidden items-center gap-6 text-sm sm:flex">
          ...
          <a href="mailto:cristi.stiegelbauer@gmail.com" className="rounded-full border px-3 py-1 text-sm micro-btn">Contact</a>
        </nav>
        ...
        <div className="sm:hidden">
          <button
            ...
            onClick={() => setOpen((v) => !v)}
            className="inline-flex items-center justify-center rounded-md p-2 text-zinc-600 micro-btn micro-icon"
          >
  ...
  <div className="sm:hidden border-t border-black/4 bg-(--color-background)">
          <div className="mx-auto max-w-6xl px-6 py-4">
            <div className="flex flex-col gap-3 text-sm">
              ...
              <a href="mailto:cristi.stiegelbauer@gmail.com" className="rounded-full border px-3 py-1 text-sm w-max micro-btn">Contact</a>
            </div>
          </div>
        </div>
      )}
