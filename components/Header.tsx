  ...
  <header className="border-b border-black/6 bg-transparent py-4">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6">
        ...
        <nav className="hidden items-center gap-6 text-sm sm:flex">
          ...
          <a href="mailto:cristi.stiegelbauer@gmail.com" className="rounded-full border px-3 py-1 text-sm hover:bg-black/5">Contact</a>
        </nav>
        ...
        <div className="sm:hidden">
          <button
            ...
            onClick={() => setOpen((v) => !v)}
            className="inline-flex items-center justify-center rounded-md p-2 text-zinc-600 hover:bg-black/5"
          >
  ...
  <div className="sm:hidden border-t border-black/4 bg-(--color-background)">
          <div className="mx-auto max-w-6xl px-6 py-4">
            <div className="flex flex-col gap-3 text-sm">
              ...
              <Link href="/awards" onClick={() => setOpen(false)} className="block">Awards</Link>
              <a href="mailto:cristi.stiegelbauer@gmail.com" className="rounded-full border px-3 py-1 text-sm w-max">Contact</a>
            </div>
          </div>
        </div>
      )}
