      ...
      <div className="p-5">
        ...
        <div className="mt-4 flex items-center gap-4">
          ...
          <div className="ml-auto flex items-center gap-3">
            {github && (
              <a href={github} target="_blank" rel="noreferrer" title="View source (GitHub)" className="text-zinc-600 hover:text-black">
                {/* GitHub icon */}
            ...
            {link && (
              <a href={link} target="_blank" rel="noreferrer" title="Open project" className="text-zinc-600 hover:text-black">
                {/* external link icon */}
