  ...
  return (
    <section className="py-8">
      <div className="mx-auto max-w-5xl px-6">
        <h1 className="text-3xl font-bold">Skills & Passions</h1>
        <p className="mt-2 text-zinc-600">A quick overview of technical skills and areas I enjoy working in.</p>
        ...
        <div className="mt-8">
          <h2 className="text-2xl font-semibold">Other passions</h2>
